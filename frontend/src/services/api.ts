...
import type {
  ...
  EnrollmentResponse, EnrollmentStatusResponse, UserResponse
} from '../types';
...
export const adminService = {
  getInstructors: () => api.get<UserResponse[]>('/admin/instructors'),
  approveUser: (userId: number) => api.put<MessageResponse>(`/admin/users/${userId}/approve`),
  revokeUser: (userId: number) => api.put<MessageResponse>(`/admin/users/${userId}/revoke`),
};
